module github.com/cleverhu/custom-scheduler
...
// Kubernetes is developed in its own repository, k8s.io/kubernetes
// Users importing k8s.io/kubernetes will actually import staging repos like k8s.io/api
replace (
